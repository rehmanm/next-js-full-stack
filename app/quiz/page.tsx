...
async function page() {
  const data: RandomQuizResponse = await getRandomQuizQuestion();
  console.log(data);
  if (data === null) {
    return (
  ...
  return (
    <Container as="main" className="flex flex-col gap-5 md:flex-row-reverse md:justify-between">
      ...
      <div className="md:w-[50%] flex flex-col gap-5">
        ...
        <p className="text-sm leading-6 text-gray-300">
          Take this quiz to find out how much you know about the hit animated sitcom Family Guy.
          Test your knowledge of the characters, the episodes, and the show&apos;s many pop culture
          references.
        </p>
        <Link
